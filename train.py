...
def main():
    ...
    data_module = EpilepsyDataModule(
        ...
        p_time_shift=config['data'].get('p_time_shift', 0.3),
        time_shift_mode=config['data'].get('time_shift_mode', 'cyclic'),
        time_shift_fill=config['data'].get('time_shift_fill', 'zero'),
        p_channel_dropout=config['data'].get('p_channel_dropout', 0.2),
        p_channel_attenuation=config['data'].get('p_channel_attenuation', 0.0),
        channel_attenuation_range=config['data'].get('channel_attenuation_range', (0.2, 0.7)),
        p_mixup=config['data'].get('p_mixup', 0.3),
        mixup_alpha=config['data'].get('mixup_alpha', 0.3),
        p_cutmix=config['data'].get('p_cutmix', 0.2),
        cutmix_min_len=config['data'].get('cutmix_min_len', 200),
        cutmix_max_len=config['data'].get('cutmix_max_len', 800),
