...
def evaluate_balancing_effectiveness(y_true, y_pred, y_pred_proba=None):
    ...
    seizure_precision = report['1']['precision'] if '1' in report else 0
    seizure_recall = report['1']['recall'] if '1' in report else 0
    seizure_f1 = report['1']['f1-score'] if '1' in report else 0
